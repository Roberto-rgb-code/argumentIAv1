...
class ChatbotDuolingoPage extends StatefulWidget {
  const ChatbotDuolingoPage({super.key});

  @override
  State<ChatbotDuolingoPage> createState() => _ChatbotDuolingoPageState();
}

class _ChatbotDuolingoPageState extends State<ChatbotDuolingoPage>
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Elige tu tema de debate',
                              style: Theme.of(context).textTheme.headlineMedium?.copyWith(
                                color: AppTheme.charcoalBlack,
                              ),
                            ),
                            Text(
                              'Selecciona un tema que te interese debatir',
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Desarrolla tus habilidades argumentativas',
                              style: Theme.of(context).textTheme.bodyMedium?.copyWith(
            ...
            AnimatedBuilder(
              ...
              builder: (context, child) {
                return Transform.scale(
                  ...
                  child: DialectaAnimations.successAnimation(),
                );
              },
            ),
            const SizedBox(height: 24),
